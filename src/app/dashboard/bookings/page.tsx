    ...
    <div className="space-y-md">
          ...
          return (
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-semibold transition border whitespace-nowrap shrink-0 ${
                filter === f ? "bg-primary-container text-white border-primary-container" : "bg-surface-container-lowest text-on-surface-variant border-outline-variant hover:border-primary-container"
              }`}
            >
              {label}
      ...
      {filtered.length === 0 ? (
        <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-xl text-center">
          <span className="material-symbols-outlined text-4xl text-on-surface-variant/40 mb-2 block">event_note</span>
          ...
          {filtered.map((b) => {
            ...
            return (
              <Link
                ...
                className="block bg-surface-container-lowest border border-outline-variant rounded-xl p-md hover:border-primary-container transition-colors"
              >
                <div className="flex items-start gap-md">
                  ...
                  <div className="text-right shrink-0">
                    <p className="text-primary-container font-bold text-sm">AED {Number(b.total_price).toLocaleString()}</p>
