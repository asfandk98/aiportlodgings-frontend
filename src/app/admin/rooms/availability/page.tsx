          ...
          {selectedRoom && (
            <div className="bg-white border border-outline-variant rounded-xl p-lg">
              <div className="flex justify-between items-center mb-md">
                <button onClick={prevMonth} className="text-on-surface-variant hover:text-primary-container transition">
                  <span className="material-symbols-outlined">chevron_left</span>
                </button>
                <h2 className="text-primary font-medium">
                  {MONTHS[month]} {year}
                </h2>
                <button onClick={nextMonth} className="text-on-surface-variant hover:text-primary-container transition">
                    ...
                    return (
                      <button
                        ...
                        className={`aspect-square rounded-lg text-sm relative transition-colors
                          ...
                          ${picked ? "bg-secondary-container text-primary scale-105" : ""}
                        `}
                      >
                        {day}
              ...
              <div className="flex items-center gap-4 mt-md pt-md border-t border-outline-variant text-xs text-on-surface-variant">
                ...
                <span className="flex items-center gap-1.5">
                  <span className="w-2.5 h-2.5 rounded-sm bg-secondary-container inline-block" /> Selected
                </span>
              </div>
            </div>
          )}
