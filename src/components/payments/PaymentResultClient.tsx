        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-12">
          ...
          <div className="md:col-span-5 relative overflow-hidden rounded-xl h-[300px] md:h-auto border border-outline-variant bg-primary-container flex items-end p-6">
            <div className="text-on-primary">
              <span className="font-label-caps text-label-caps mb-1 block">{result.room_name}</span>
              <p className="text-on-primary/80 text-body-sm">
                {result.nights} Night{result.nights !== 1 ? "s" : ""} • {result.guests}
              </p>
            </div>
          </div>
