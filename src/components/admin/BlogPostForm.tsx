  ...
  const ImageUpload = ({
    ...
    <div className="space-y-2">
      ...
      <label className="block cursor-pointer">
        <div className="border-2 border-dashed border-outline-variant hover:border-primary-container rounded-lg p-5 text-center transition">
          {preview ? (
    ...
    <div className="max-w-4xl space-y-md pb-xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-md">
        <Section title="Post Details">
          <Field label="Title *">
            <input name="title" value={form.title} onChange={handleChange} required placeholder="e.g. How to Survive a 6-Hour Layover in DXB" className="admin-input" />
          </Field>
        ...
        <Section title="Publish Settings">
          ...
          <div className="flex items-center gap-xl pt-2">
            <Toggle
              label="Active"
        ...
        <div className="flex gap-3">
          <button type="submit" disabled={saving} className="flex-1 bg-primary-container text-white py-3 rounded-lg font-label-bold text-label-bold hover:opacity-90 transition disabled:opacity-50">
